...
<body>
<div name="gauche" style="clear:left:;float:left;width:18%; background-color:grey; height:100%;">
<div name="coin" style="height:10%;text-align:center;"><img src="logo.png" width="100" height="60"/></div>
</div>
<div name="droite" style="float:left;width:80%;">
	<div name="haut" style="margin: 2 2 2 2 ;height:10%;float:left;"><h1 style="color :white">Gestion des Frais</h1></div>	
	...
	<form name="formSaisieFrais" method="post" action="enregSaisieFrais.php">
		...
		<div style="clear:left;">			
			...
			<div style="float:left;width:220;text-align:center;">Libelle</div>
